...
while True:
    ...
    if choice in ('1', '2', '3', '4'):
        ...
        if choice == '1':
            print("Solution:", num1, "+", num2, "=", round(add(num1, num2), 2))
            print('')

        elif choice == '2':
            print("Solution:", num1, "-", num2, "=", round(subtract(num1, num2), 2))
            print('')

        elif choice == '3':
            print("Solution:", num1, "x", num2, "=", round(multiply(num1, num2), 2))
            print('')

        elif choice == '4':
            print("Solution:", num1, ":", num2, "=", round(divide(num1, num2), 2))
            print('')
